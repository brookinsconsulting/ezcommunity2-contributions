...
<tr>
    <td colspan="2" bgcolor="#90a0b0" background="{www_dir}/images/menufade-right2.jpg" class="menuhead" align="right">{intl-userinfo}</td>
    <td width="1%" bgcolor="#90a0b0"><img src="{www_dir}/images/1x1.gif" width="1" height="1" alt="" /></td>
</tr>
<tr>
	<td colspan="2" class="menubold" align="right">
	{intl-userlogin}:<img src="{www_dir}/images/1x1.gif" width="4" height="1" border="0" alt="" />
	</td>
    <td width="1%" bgcolor="#90a0b0"><img src="{www_dir}/images/1x1.gif" width="1" height="1" alt="" /></td>
</tr>
<tr>
	<td colspan="2" class="menu" align="right">
	{first_name} {last_name}<img src="{www_dir}/images/1x1.gif" width="4" height="1" border="0" alt="" />
	</td>
    <td width="1%" bgcolor="#90a0b0"><img src="{www_dir}/images/1x1.gif" width="1" height="1" alt="" /></td>
</tr>
<tr>
	<td colspan="2" align="right">
	<input class="stdbutton" type="submit" value="{intl-logout}" /><img src="{www_dir}/images/1x1.gif" width="4" height="1" border="0" alt="" />
	</td>
    <td width="1%" bgcolor="#90a0b0"><img src="{www_dir}/images/1x1.gif" width="1" height="1" alt="" /></td>
</tr>
<tr>
	<td width="99%" align="right"><a class="menu" href="{www_dir}{index}{user_edit_url}/{user_id}/">{intl-change_user_info}</a></td>
