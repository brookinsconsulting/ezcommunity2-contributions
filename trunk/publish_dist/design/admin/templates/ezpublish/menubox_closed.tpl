...
<tr>
    ...
    <td class="repeatx" width="98%" background="{www_dir}/design/admin/images/{site_style}/top-m02.gif" valign="absmiddle" bgcolor="#b5b5b5"><img src="{www_dir}/design/admin/images/{site_style}/1x1.gif" width="160" height="10" border="0" alt="" /><br /></td>
