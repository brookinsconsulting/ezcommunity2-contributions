...
<!-- BEGIN category_list_tpl -->
	...
	<!-- BEGIN no_image_tpl --> 
	<!-- END no_image_tpl -->
<p><a href="{www_dir}{index}/article/archive/{category_id}/">{category_name}</a></p>
...
{article_intro}<br />
<!-- BEGIN read_more_tpl -->
<a href="{www_dir}{index}/article/articleview/{article_id}/1/{category_id}/">{article_link_text}</a>
<!-- END read_more_tpl -->
