...
<textarea class="box" name="InvalidContents" cols="60" rows="5" wrap="soft">{article_invalid_contents}</textarea>
...
<input class="box" type="text" name="Name" size="60" value="{article_name}" />
<br /><br />
...
<input class="box" type="text" name="Keywords" size="60" value="{article_keywords}" />
<br /><br />

<p class="boxtext">{intl-intro}:</p>
<textarea class="box" name="Contents[]" cols="60" rows="4" wrap="soft">{article_contents_0}</textarea>
<br /><br />

<p class="boxtext">{intl-contents}:</p>
<textarea class="box" name="Contents[]" cols="60" rows="40" wrap="soft">{article_contents_1}</textarea>
<br /><br />
...
<textarea class="box" name="LogMessage" cols="60" rows="3" wrap="soft"></textarea>
<br />
