...
-->
	<span class="subdiv"><a href="{www_dir}{index}/procurement/archive/{option_value}">{option_name}</a></span><br />
	</td>
</tr>
...
<span class="subdiv">
	<a href="{www_dir}{index}/procurement/view/{option_value}/1/{category_id}">{option_name}</a></span><br />
	</td>
</tr>
<!-- END rfp_value_tpl -->
