...
switch ( $url_array[2] )
{
    ...
    {
        $Action = $url_array[2];
        $ProcurementID = $url_array[3];

        // $Month = $url_array[4];
        // print("Hit Case: $Action ");
        include( "ezprocurement/user/procurement_edit.php" );
    }
    break;
...
print( "Insert procurementdownload.php function <br /> Check for Authenticated Session, Insert Client Stats Capture & Redirect to File Download");
    exit();
    }
    break;
    ...
    case "frontpage":
    {
        ...
        if ( $PageCaching == "enabled" )
        {
            ...
            $file = new eZCacheFile( "ezrfp/cache/", array( "procurementfrontpage", $GlobalSectionID, $groupstr ),
                                     "cache", "," );
...
//        print( "Checking category: $CategoryID <br>" );
        ...
        if ( $PageCaching == "enabled" )
        {
            ...
            include_once( "classes/ezcachefile.php" );
            $file = new eZCacheFile( "ezrfp/cache/", array( "procurementlist", $CategoryID, $Offset, $groupstr ),
                                     "cache", "," );
...
//            print( "Cache file name: $cachedFile" );
    ...
    case "index":
    {
        ...
        include_once( "classes/ezcachefile.php" );
        $file = new eZCacheFile( "ezrfp/cache/", array( "procurementindex", $groupstr, $CurrentIndex ),
                                 "cache", "," );
    ...
    case "procurementview":
    {
        ...
        if ( $PageCaching == "enabled" )
        {
            $cachedFile = "ezrfp/cache/procurementview," . $RfpID . ",". $PageNumber . "," . $CategoryID . "," . ( $PrintableVersion == "enabled" )  . "," . $groupstr  .".cache";
...
//		print( " Include Cached File <br>" );
    ...
    case "procurementprint":
    {
        ...
        if ( $PageCaching == "enabled" )
        {
             $cachedFile = "ezrfp/cache/procurementprint," . $RfpID . ",". $PageNumber . "," . $CategoryID . "," . $groupstr  .".cache";
            if ( eZFile::file_exists( $cachedFile ) )
            {
                include( $cachedFile );
            }
    ...
    case "procurementstatic":
    {
        ...
        if ( $PageCaching == "enabled" )
        {
            $cachedFile = "ezrfp/cache/procurementview," . $RfpID . ",". $PageNumber . "," . $CategoryID . "," . $groupstr  .".cache";
            if ( eZFile::file_exists( $cachedFile ) )
            {
                include( $cachedFile );
            }
    ...
    case "rfpedit":
    {
        ...
        {
            include_once( "classes/ezhttptool.php" );
            eZHTTPTool::header( "Location: /procurement/archive/0" );
            exit();
        }
    }
    break;
