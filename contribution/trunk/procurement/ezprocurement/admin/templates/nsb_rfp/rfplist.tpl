...
<tr>
	...
	<form action="{www_dir}{index}/procurement/archive/" method="post">
	...
	<form action="{www_dir}{index}/procurement/archive/{current_category_id}/" method="post">
...
<hr noshade="noshade" size="4" />
	...
	<a class="path" href="{www_dir}{index}/procurement/archive/0/">{intl-topcategory}</a>
	<!-- BEGIN path_item_tpl -->
...
<form method="post" action="{www_dir}{index}/procurement/archive/{category_id}/" enctype="multipart/form-data">
...
<tr>
	...
	<td class="{td_class}">
	<a href="{www_dir}{index}/procurement/archive/{category_id}/">{category_name}</a>&nbsp;
	</td>
	<td class="{td_class}">
	{category_description}&nbsp;
	</td>
	<td width="1%" class="{td_class}">
	<a href="{www_dir}{index}/procurement/archive/{current_category_id}/?MoveCategoryDown={category_id}"><img src="{www_dir}/admin/images/{site_style}/move-down.gif" height="12" width="12" border="0" alt="Down" /></a>
	</td>
	<td width="1%" class="{td_class}">
	<a href="{www_dir}{index}/procurement/archive/{current_category_id}/?MoveCategoryUp={category_id}"><img src="{www_dir}/admin/images/{site_style}/move-up.gif" height="12" width="12" border="0" alt="Up" /></a>
	</td>

<!-- BEGIN category_edit_tpl -->
	<td width="1%" class="{td_class}">
	<a href="{www_dir}{index}/procurement/categoryedit/edit/{category_id}/" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('ezac{category_id}-red','','{www_dir}/admin/images/{site_style}/redigerminimrk.gif',1)"><img name="ezac{category_id}-red" border="0" src="{www_dir}/admin/images/{site_style}/redigermini.gif" width="16" height="16" align="top"></a>
	</td>
...
<tr>
	...
	<a href="{www_dir}{index}/procurement/preview/{rfp_id}/">{rfp_name}</a>
	</td>
	<td width="1%" class="{td_class}">
	...
	<td width="1%" class="{td_class}">
	<a href="{www_dir}{index}/procurement/archive/{current_category_id}/?MoveDown={rfp_id}"><img src="{www_dir}/admin/images/{site_style}/move-down.gif" height="12" width="12" border="0" alt="Down" /></a>
	</td>
	<td width="1%" class="{td_class}">
	<a href="{www_dir}{index}/procurement/archive/{current_category_id}/?MoveUp={rfp_id}"><img src="{www_dir}/admin/images/{site_style}/move-up.gif" height="12" width="12" border="0" alt="Up" /></a>
	</td>
	<!-- END absolute_placement_item_tpl -->
        <!-- BEGIN rfp_edit_tpl -->
	<td width="1%" class="{td_class}">
	<a href="{www_dir}{index}/procurement/edit/edit/{rfp_id}/" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('ezaa{rfp_id}-red','','{www_dir}/admin/images/{site_style}/redigerminimrk.gif',1)"><img name="ezaa{rfp_id}-red" border="0" src="{www_dir}/admin/images/{site_style}/redigermini.gif" width="16" height="16" align="top" border="0" alt="Edit" /></a>
	</td>
	<td class="{td_class}" width="1%" align="center">
