...
//!! eZRfp
//! eZTechRenderer renders XML contents into html rfps.
/*!
  This class wil decode the tech rfps generated by eZTechGenerator.
  Supported tags:
  \code
  <page> - pagebreak
  <header>
                        ...
                        {                           
                            if ( count( $rfp->children ) > 0 )
                            {
                                foreach ( $rfp->children as $paragraph )
                                {
                                    ...
                                    $intro = $this->renderImage( $intro, $paragraph, $rfpImages );
...
//        $xml =& qdom_tree( $this->Rfp->contents() );
        ...
        else
        {
                ...
                if ( $page->name == "page" )
                {
                    ...
                    if ( count( $page->children ) > 0 )
                        foreach ( $page->children as $paragraph )
                        {
                            ...
                            $pageContent = $this->renderImage( $pageContent, $paragraph, $rfpImages );
            ...
            if ( $pageNumber == -1 )
            {
//                $newRfp = "<span class=\"intro\">" . $intro . "</span>\n</p><p>\n";
            ...
            {
//                  $newRfp = eZTextTool::nl2br( $intro ) . "</p><p>". $pageArray[$pageNumber];
    ...
    */
    function &renderModule( $pageContent, $paragraph )
    {
        ...
        if ( $paragraph->name == "module" )
        {
            ...
            {
                $moduleFile = "ezrfp/modules/" . $name . ".php";                
            }
    ...
    function &renderImage( $pageContent, $paragraph, $rfpImages )
    {
        global $GlobalSiteIni;
            ...
            if ( get_class( $image ) == "ezimage" )
            {
                ...
                {                            
                    $imageTags = "<br clear=\"all\"><table width=\"$imageWidth\" align=\"$imageAlignment\" border=\"0\" cellspacing=\"0\" cellpadding=\"4\">
                                            <tr>
                                            <td>
                                                         <a href=\"" . $GlobalSiteIni->WWWDir . $GlobalSiteIni->Index . "/imagecatalogue/imageview/$imageID/?RefererURL=/rfp/$viewMode/$rfpID/\">
                ...
                {                    
                    $imageTags = "<a href=\"" . $GlobalSiteIni->WWWDir . $GlobalSiteIni->Index . "/imagecatalogue/imageview/$imageID/?RefererURL=/rfp/$viewMode/$rfpID/\"><img src=\"" . $GlobalSiteIni->WWWDir . "$imageURL\" border=\"0\" width=\"$imageWidth\" height=\"$imageHeight\" alt=\"\" /></a>";
                }
                $pageContent .=  $imageTags;
            }
            else
            {
                eZLog::writeError( "Image nr: $imageID not found in rfp: $rfpID from IP: $REMOTE_ADDR" );        
            }
        }
        return $pageContent;
    }
