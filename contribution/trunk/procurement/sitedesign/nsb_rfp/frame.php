...
xmlns="http://www.w3.org/1999/xhtml" xml:lang="no" lang="no">
...
<head>
	...
	if ( isset( $SiteTitleAppend ) )
	    ...
	    print( $SiteTitle );
?></title>
	<link rel="stylesheet" type="text/css" href="<? print $GlobalSiteIni->WWWDir; ?>/sitedesign/<? print ($GlobalSiteDesign); ?>/w3cstyle.css" />
	<link rel="shortcut icon" href="http://procurement.north-slope.org/favicon.ico" type="image/x-icon" />
...
<body>
	<div id="LayerLogo" class="LayerLogo" align="center" style="">
		<a href="/"><img src="/sitedesign/nsb_rfp/images/logo.gif" width="137" height="136" alt="North Slope Borough Logo" border="0" /></a>
	</div>
...
<!--
                 <span class="LayerMenuItem"><a href="/proposals/map">Proposals Map</a></span>
		 <span class="LayerMenuItem"><a href="/proposals/files">Attachments Map</a></span>
                 <span class="LayerMenuItem"><a href="/filemanager/map">Attachments Map</a></span>
-->
	...
	<div id="LayerMain" class="LayerMain" style="">
		...
		<span class="copyrights">Content & Visual Design &#169; <? print date("Y"); ?> <br /> North Slope Borough All Rights Reserved.<br /> Web Application released under the <a style="text-decoration:none;" href="/copyleft">GNU/GPL</a>  </span>
	  	</div>
        </div>
