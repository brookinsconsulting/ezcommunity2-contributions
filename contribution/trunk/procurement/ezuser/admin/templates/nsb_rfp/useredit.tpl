...
<tr>
	<td colspan="2">
	<p class="boxtext">{intl-organization}:</p>
	<input type="text" class="box" size="40" name="CompanyName" value="{company_name_value}"/>
	<br /><br />
	</td>
</tr>
<tr>
...
<tr>
	<td colspan="2">
	<input {info_subscription} type="checkbox" name="DeadlineReminders" />
	<span class="p">{intl-deadlinereminders}</span>
	</td>
</tr>
<tr>
	<td colspan="2">
	<input {info_subscription} type="checkbox" name="InfoDisclaimer" />
	<span class="p">{intl-infodisclaimer}</span>
	</td>
</tr>
<tr>
	<td colspan="2">
	<input {info_subscription} type="checkbox" name="AccountActive" />
	<span class="p">{intl-acountactive}</span>
	</td>
</tr>
