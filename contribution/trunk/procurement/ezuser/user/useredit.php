<?php
// 
// $Id: useredit.php,v 1.24.2.1 2002/05/08 11:51:36 vl Exp $
//
...
if ( $Action == "Insert" )
{
    ...
    $LastName != "" )
    {
		...
		// groups addtion section of user/user/insert!!!
		...
		// redirect user from the insert to the account acctivation code, sendMail(), then allow user to continue with their fdd drive lie of lives.
		// also see user/datasource
//include_once( "ezuser/user/createconfirmation.php");
//include_once( "ezuser/user/createconfirmationmessage.php");
