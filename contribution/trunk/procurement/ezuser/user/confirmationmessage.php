<?php
// 
// $Id: confirmationmessage.php,v 1.3 2001/07/20 11:45:40 jakobn Exp $
//
...
$t = new eZTemplate( "ezuser/user/" . $ini->read_var( "eZUserMain", "TemplateDir" ),
                     "ezuser/user/intl/", $Language, "confirmationmessage.php" );

$t->setAllStrings();
$t->set_file( array( "message" => "confirmationmessage.tpl" ) );
