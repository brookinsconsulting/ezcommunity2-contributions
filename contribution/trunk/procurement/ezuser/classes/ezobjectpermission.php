...
function getTableName( $name, $withDefinition=false )
{
    ...
    switch ( $name )
    {
        ...
        case "rfp_rfp" :
            if ( $withDefinition )
                $ret = "eZRfp_RfpPermission as Object, eZRfp_CategoryPermission as Category, eZRfp_RfpCategoryDefinition as Definition";
            else
                $ret = "eZRfp_RfpPermission";
        break;

        case "rfp_category" :
            $ret = "eZRfp_CategoryPermission";
        break;
