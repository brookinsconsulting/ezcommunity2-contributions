<?php
// 
// $Id: unpublishedlist.php,v 1.14 2001/08/24 12:38:08 th Exp $
//
...
$languageIni = new INIFIle( "ezrfp/admin/intl/" . $Language . "/unpublishedlist.php.ini", false );
...
$t = new eZTemplate( "ezrfp/admin/" . $ini->read_var( "eZRfpMain", "AdminTemplateDir" ),
                     "ezrfp/admin/intl/", $Language, "unpublishedlist.php" );
...
// rfp
$t->set_block( "unpublished_list_page_tpl", "rfp_list_tpl", "rfp_list" );
...
$rfpList =& $rfp->rfps( "time", "only",  $Offset, $Limit );
$rfpCount = $rfp->rfpCount( "only" );
...
eZList::drawNavigator( $t, $rfpCount, $AdminListLimit, $Offset, "unpublished_list_page_tpl" );
