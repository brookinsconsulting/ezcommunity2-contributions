<form method="post" action="{www_dir}{index}/rfp/type/edit">
...
<!-- BEGIN item_move_down_tpl -->
	<td width="1%" align="right"><a href="{www_dir}{index}/rfp/type/down/{type_id}/{attribute_id}"><img src="{www_dir}/admin/images/move-down.gif" height="12" width="12" border="0" alt="Move down" /></a></td>
...
<!-- BEGIN item_move_up_tpl -->
	<td width="1%" align="right"><a href="{www_dir}{index}/rfp/type/up/{type_id}/{attribute_id}"><img src="{www_dir}/admin/images/move-up.gif" height="12" width="12" border="0" alt="Move up" /></a></td>
