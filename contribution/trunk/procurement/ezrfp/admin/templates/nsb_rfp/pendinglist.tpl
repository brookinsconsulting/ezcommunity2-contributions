...
<form method="post" action="{www_dir}{index}/rfp/pendinglist/{current_category_id}/" enctype="multipart/form-data">
<!-- BEGIN rfp_item_tpl -->
<tr>
...
<tr>
	...
	<td>
	<a class="path" href="{www_dir}{index}/rfp/pendinglist/{archive_id}/parent/{item_previous_index}">&lt;&lt;&nbsp;{intl-previous}</a>&nbsp;
	</td>
	...
	<td>
	|&nbsp;<a class="path" href="{www_dir}{index}/rfp/pendinglist/{archive_id}/parent/{item_index}">{type_item_name}</a>&nbsp;
	</td>
	...
	<td>
	|&nbsp;<a class="path" href="{www_dir}{index}/rfp/pendinglist/{archive_id}/parent/{item_next_index}">{intl-next}&nbsp;&gt;&gt;</a>
	</td>
