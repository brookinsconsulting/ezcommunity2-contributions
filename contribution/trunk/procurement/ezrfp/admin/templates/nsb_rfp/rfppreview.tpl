...
<a class="path" href="{www_dir}{index}/rfp/rfppreview/{rfp_id}/{prev_page_number}/">&lt;&lt; {intl-prev_page}</a>
<!-- END prev_page_link_tpl -->

<!-- BEGIN page_link_tpl -->
| <a class="path" href="{www_dir}{index}/rfp/rfppreview/{rfp_id}/{page_number}/">{page_number}</a>	
<!-- END page_link_tpl -->

<!-- BEGIN next_page_link_tpl -->
| <a class="path" href="{www_dir}{index}/rfp/rfppreview/{rfp_id}/{next_page_number}/">{intl-next_page} &gt;&gt;</a>
