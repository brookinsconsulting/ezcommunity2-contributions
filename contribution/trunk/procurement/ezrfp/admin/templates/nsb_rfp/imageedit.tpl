<form method="post" action="{www_dir}{index}/rfp/rfpedit/imageedit/" enctype="multipart/form-data">
<input type="hidden" name="max_file_size" value="3000000">

<h1>{intl-imageupload}: {rfp_name}</h1>
...
<tr>
	...
	<form method="post" action="{www_dir}{index}/rfp/rfpedit/imagelist/{rfp_id}/">
