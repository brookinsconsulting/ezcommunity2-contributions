<?php
// 
// $Id: typelist.php,v 1.2 2001/07/19 12:19:21 jakobn Exp $
//
...
if( isset( $Delete ) )
{
    ...
    {
        $typed = new eZrfpType( $typeid );
        $typed->delete();
    }
}

$t = new eZTemplate( "ezrfp/admin/" . $ini->read_var( "eZTradeMain", "AdminTemplateDir" ),
                     "ezrfp/admin/intl/", $Language, "typelist.php" );
