...
// don't give the regulare screen, just cause it's a dependancy.
    eZHTTPTool::header( "Location: /filemanager/filelist/0" . $RfpID . "/" );
    exit();    


$t = new eZTemplate( "ezrfp/admin/" . $ini->read_var( "eZRfpMain", "AdminTemplateDir" ),
                     "ezrfp/admin/intl/", $Language, "fileedit.php" );
