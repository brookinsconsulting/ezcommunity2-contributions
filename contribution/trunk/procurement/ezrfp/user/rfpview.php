...
// fix ezerror module, restore some 404/403 function ality to display
// error or kick to / 
// case : add one to ezerror for download login instead of hackin existing
...
*/
	...
	$t->set_var( "author_text", "North Slope Burough" );
        $t->set_var( "author_id", "1" );
	

/*
	$theContentsWritersDT = is_array($theContentsWriters);
	if ( is_array($theContentsWriters) ){
		print("Is Array");
		exit();
	}else {
		print($theContentsWriters;
                exit();
        }
*/

//	v_array($theContentsWriters);
//	 v_array($theContentsWritersp[0]);
