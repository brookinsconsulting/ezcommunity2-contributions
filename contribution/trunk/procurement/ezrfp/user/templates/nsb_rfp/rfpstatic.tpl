...
<a class="path" href="{www_dir}{index}/rfp/archive/0/">{intl-top_level}</a>
-->
...
<tr>
	<td>
	<p class="byline">{intl-rfp_author}: <a class="byline" href="{www_dir}{index}/rfp/author/view/{author_id}">{author_text}</a></p>
	</td>
	<td align="right">
...
| <a class="path" href="{www_dir}{index}/rfp/rfpview/{rfp_id}/0/{category_id}/">{intl-numbered_page}</a> |
