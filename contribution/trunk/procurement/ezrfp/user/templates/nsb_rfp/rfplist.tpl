...
<div class="header" style="position:relative;">
	...
	<!-- END rfp_path_header_tpl -->
		...
		<div style="">
		 <span class="body"><a href="/rfp/archive/10/">North Slope Borough</a></span><br />
...
<!-- BEGIN category_item_tpl -->
	...
	<span class="body"><a href="{www_dir}{index}/rfp/archive/{category_id}/">{category_name}</a></span><br>
