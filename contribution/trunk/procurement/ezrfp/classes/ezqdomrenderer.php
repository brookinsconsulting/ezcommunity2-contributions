<?php
//
// $Id: ezqdomrenderer.php,v 1.55.2.23 2003/05/07 07:57:23 br Exp $
//
...
//!! eZRfp
//! eZQDomRenderer renders XML contents into html rfps.
/*!
  This class wil decode the QDom rfps generated by eZQDomGenerator.
  Supported tags:
  \code
  <page> - pagebreak
  <header>
...
class eZQDomrenderer
{
    ...
    */
    function eZQDomrenderer( &$rfp, $template=false )
    {
        $UsedImageList = array();
        $RollOverCount = 0;
        ...
        $this->Template = new eZTemplate( "ezrfp/user/" . $ini->read_var( "eZRfpMain", "TemplateDir" ),
                     "ezrfp/user/intl/", "en_GB", "rfpview.php" );

        if ( file_exists( "ezrfp/user/" . $ini->read_var( "eZRfpMain", "TemplateDir" ) . "rfptags_$template.tpl" ) )
        {
            $this->Template->set_file( "rfptags_tpl", "rfptags_$template.tpl"  );
        }
        else
        {
            $this->Template->set_file( "rfptags_tpl", "rfptags.tpl"  );

        }

        $this->Template->set_block( "rfptags_tpl", "header_1_tpl", "header_1"  );
        $this->Template->set_block( "rfptags_tpl", "header_2_tpl", "header_2"  );
        $this->Template->set_block( "rfptags_tpl", "header_3_tpl", "header_3"  );
        $this->Template->set_block( "rfptags_tpl", "header_4_tpl", "header_4"  );
        $this->Template->set_block( "rfptags_tpl", "header_5_tpl", "header_5"  );
        $this->Template->set_block( "rfptags_tpl", "header_6_tpl", "header_6"  );

        $this->Template->set_block( "rfptags_tpl", "rollover_tpl", "rollover"  );

        $this->Template->set_block( "rfptags_tpl", "image_tpl", "image"  );
        $this->Template->set_block( "rfptags_tpl", "media_tpl", "media"  );
        $this->Template->set_block( "rfptags_tpl", "file_tpl", "file"  );
        ...
        $this->Template->set_block( "rfptags_tpl", "image_float_tpl", "image_float" );
        ...
        $this->Template->set_block( "rfptags_tpl", "link_tpl", "link"  );
        $this->Template->set_block( "rfptags_tpl", "popuplink_tpl", "popuplink"  );

        $this->Template->set_block( "rfptags_tpl", "hr_tpl", "hr"  );

        $this->Template->set_block( "rfptags_tpl", "bold_tpl", "bold"  );
        $this->Template->set_block( "rfptags_tpl", "italic_tpl", "italic"  );
        $this->Template->set_block( "rfptags_tpl", "underline_tpl", "underline"  );
        $this->Template->set_block( "rfptags_tpl", "strong_tpl", "strong"  );
        $this->Template->set_block( "rfptags_tpl", "strike_tpl", "strike"  );
        $this->Template->set_block( "rfptags_tpl", "factbox_tpl", "factbox"  );
        $this->Template->set_block( "rfptags_tpl", "quote_tpl", "quote"  );
        $this->Template->set_block( "rfptags_tpl", "pre_tpl", "pre"  );
        $this->Template->set_block( "rfptags_tpl", "html_tpl", "html"  );

        // lists
        $this->Template->set_block( "rfptags_tpl", "bullet_tpl", "bullet"  );
        $this->Template->set_block( "bullet_tpl", "bullet_item_tpl", "bullet_item"  );

        $this->Template->set_block( "rfptags_tpl", "list_tpl", "list"  );
        $this->Template->set_block( "list_tpl", "list_item_tpl", "list_item"  );

        // table
        $this->Template->set_block( "rfptags_tpl", "table_tpl", "table"  );
        ...
        {
            $this->Template->set_block( "rfptags_tpl", $tag . "_tpl", "$tag"  );
        }

        // get custom <br> command, needed for other renderes than html
        $this->BrOverride = $this->Template->get_user_variable( "rfptags_tpl",  "br" );
...
//        $xml =& xmltree( $this->Rfp->contents() );
        $xml =& eZXML::domTree( $this->Rfp->contents() );
            ...
            foreach ( $xml->children as $child )
            {
                if ( $child->name == "rfp" )
                {
                    foreach ( $child->children as $rfp )
                    {
                        if ( $rfp->name == "intro" )
                        {
                            if ( count( $rfp->children ) > 0 )
                            {
                                foreach ( $rfp->children as $paragraph )
                                {
...
//            $newRfp = eZTextTool::nl2br( $intro );
    ...
    */
    ...
    {
//        $xml =& qdom_tree( $this->Rfp->contents() );
    ...
    */
    function &renderImage( $paragraph )
    {
        ...
        if ( $paragraph->name == "image" )
        {
            ...
            foreach ( $rfpImages as $imageArray )
            {
            ...
            if ( get_class( $image ) == "ezimage" )
            {
                ...
                if ( $hasMap == false )
                {
                    switch ( $imageSize )
                    {
                        case "small" :
                        {
                            $variation =& $image->requestImageVariation( $ini->read_var( "eZRfpMain", "SmallImageWidth" ),
                            $ini->read_var( "eZRfpMain", "SmallImageHeight" ) );
                        }
                        break;
                        case "medium" :
                        {
                            $variation =& $image->requestImageVariation( $ini->read_var( "eZRfpMain", "MediumImageWidth" ),
                            $ini->read_var( "eZRfpMain", "MediumImageHeight" ) );
                        }
                        break;
                        case "large" :
                        {
                            $variation =& $image->requestImageVariation( $ini->read_var( "eZRfpMain", "LargeImageWidth" ),
                            $ini->read_var( "eZRfpMain", "LargeImageHeight" ) );
                        }
                        break;
                ...
                $this->Template->set_var( "rfp_id", $rfpID );
    ...
    */
    function &renderLink( $paragraph )
    {
        ...
        if ( $paragraph->name == "ezrfp" )
        {
            ...
            global $GlobalSiteIni;
            $href = "$GlobalSiteIni->WWWDir$GlobalSiteIni->Index/rfp/view/" . $id;
            $this->Template->set_var( "href", $href );
        ...
        if ( $paragraph->name == "ezstatic" )
        {
            ...
            global $GlobalSiteIni;
            $href = "$GlobalSiteIni->WWWDir$GlobalSiteIni->Index/rfp/static/" . $id;
            $this->Template->set_var( "href", $href );
            $this->Template->set_var( "target", "" );
            $this->Template->set_var( "link_text", $text );
            $pageContent =& trim( $this->Template->parse( "link", "link_tpl" ) );
        ...
        if ( $paragraph->name == "ezcategory" )
        {
            ...
            global $GlobalSiteIni;
            $href = "$GlobalSiteIni->WWWDir$GlobalSiteIni->Index/rfp/archive/" . $id;
            $this->Template->set_var( "href", $href );
            $this->Template->set_var( "target", "" );
            $this->Template->set_var( "link_text", $text );
            $pageContent =& trim( $this->Template->parse( "link", "link_tpl" ) );
    ...
    /*!
      Returns the relative ID to the images used ( rendered ) in this rfp
    */
