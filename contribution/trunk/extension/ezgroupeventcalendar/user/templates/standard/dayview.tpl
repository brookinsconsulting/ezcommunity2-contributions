...
<tr><td>
	...
	<tr><td colspan="7" id="gcalDayViewMonthTableHeader" style="height: 12px; background: no-repeat url('{www_dir}{index}/ezgroupeventcalendar/user/templates/standard/images/gcalDayViewMonthTableHeader.png'); font-size: 2px;"><a href="javascript:objChangeVisiblity('gcalDayViewMonthTable')" style="text-decoration: none;"><img src="{www_dir}{index}/ezgroupeventcalendar/user/templates/standard/images/gcalX.png" style="height: 12px; z-index: 1001; margin-right:7px;" alt="close" border="0" /></a></td>
</tr></td></tr>
    <tr>
...
<tr>
	...
	<td class="{td_class}"  width="100%" id="gcalDayViewEventTimesHeight" style="text-align: center; border: 1px solid gray; border-right: 2px solid gray; background: url('{www_dir}{index}/ezgroupeventcalendar/user/templates/standard/images/gcalShortTimeBg.png') repeat;">
