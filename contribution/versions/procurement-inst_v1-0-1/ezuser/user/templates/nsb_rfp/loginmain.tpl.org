...
<tr>
	<td colspan="2"><a class="menu" href="{www_dir}{index}/user/forgot/">{intl-forgot}</a></td>
</tr>
<!-- BEGIN standard_creation_tpl -->
<tr>
	<td colspan="2"><a class="menu" href="{www_dir}{index}{user_edit_url}">{intl-register}</a></td>
</tr>
