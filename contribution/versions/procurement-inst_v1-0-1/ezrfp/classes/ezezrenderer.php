...
//!! eZRfp
//! eZEzRenderer renders XML contents into html rfps.
/*!
  This class wil decode the ez rfps generated by eZEzGenerator.
  Supported tags:
  \code
  <page> - pagebreak
  <header>
    ...
    */
    function &renderPage( $pageNumber=0 )
    {
        ...
        else
        {
            ...
            if ( $pageNumber != 0 )
            {
                $newRfp = $pageArray[$pageNumber];
            }
            else
            {
                if ( $intro != "" )
                {                    
                    $newRfp = "<p>" . eZTextTool::nl2br( $intro ) . "</p>". $pageArray[$pageNumber];
                }
                else
                {
                    $newRfp = $pageArray[$pageNumber];
