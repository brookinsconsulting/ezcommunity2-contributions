...
<form action="{www_dir}{index}/rfp/rfpedit/imagemap/store/{image_id}/{rfp_id}/" name="MapForm" method="post" onSubmit="return getValue()">
...
<tr>
	...
	<td>&nbsp;</td>
	<td>
	<form action="{www_dir}{index}/rfp/rfpedit/imagelist/{rfp_id}/" method="post">
