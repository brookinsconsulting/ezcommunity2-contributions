...
<form method="post" action="{www_dir}{index}/rfp/rfpedit/mediaedit/{rfp_id}/{media_id}" enctype="multipart/form-data">
<input type="hidden" name="max_file_size" value="3000000">

<h1>{intl-mediaupload}: {rfp_name}</h1>
...
<tr>
	<td>
	<p class="boxtext">{intl-new_creator_name}:</p>
	<input class="halfbox" type="text" name="NewCreatorName" size="20" value="" />
	</td>
	<td>
	<p class="boxtext">{intl-new_creator_email}:</p>
	<input class="halfbox" type="text" name="NewCreatorEmail" size="20" value="" />
	</td>
</tr>
</table>
...
<tr>
	<td>
	<input type="hidden" name="rfpID" value="{rfp_id}" />
	...
	<form method="post" action="{www_dir}{index}/rfp/rfpedit/medialist/{rfp_id}/">
