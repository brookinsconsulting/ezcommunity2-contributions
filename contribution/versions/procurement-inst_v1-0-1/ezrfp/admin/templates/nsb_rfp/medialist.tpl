<form action="{www_dir}{index}/rfp/rfpedit/mediaedit/{rfp_id}/" method="post">

<h1>{intl-media}: {rfp_name}</h1>
...
<tr>
	...
	<a href="{www_dir}{index}/mediacatalogue/mediaview/{media_id}/?RefererURL=/rfp/rfpedit/medialist/{rfp_id}/">{media_name}</a>
	</td>
	<td width="94%" class="{td_class}">
	{media_caption}
	</td>
