<form method="post" action="{www_dir}{index}/rfp/rfpedit/fileedit/" enctype="multipart/form-data">
<input type="hidden" name="max_file_size" value="30000000">

<h1>{intl-file_upload}: {rfp_name}</h1>
...
<tr>
	...
	<form method="post" action="{www_dir}{index}/rfp/rfpedit/filelist/{rfp_id}/">
