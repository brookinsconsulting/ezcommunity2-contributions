...
class eZImageFile extends eZFile
{
    ...
    */
    function scaleCopy( $dest, $width, $height, $convertToGray = false, $aspectScale=true )
    {
        ...
        $execstr_old = "$image_prog  -colorspace Transparent $grayCode -geometry \"$width" . "x" . "$height" . ">\" "  . $this->TmpFileName . " " . $dest;
        $execstr_mid = "$image_prog  -colorspace Transparent $grayCode -geometry \"$width" . "x" . "$height" . ">\" "  . "/home/ladiva/public_html/" . $this->TmpFileName . " " . "/home/ladiva/public_html/" . $dest . " &> /tmp/error102 ";

        $execstr = "$image_prog  -colorspace Transparent $grayCode -geometry \"$width" . "x" . "$height" . ">\" "  . "/home/ladiva/public_html/" . $this->TmpFileName . " " . "/home/ladiva/public_html/" . $dest;

        $err = system( $execstr, $ret_code );

//	print( "<br><b>$execstr</b><br>$err<hr />$ret_code" );
