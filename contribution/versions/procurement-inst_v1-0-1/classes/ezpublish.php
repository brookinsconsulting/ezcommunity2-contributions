<?php
// 
// $Id: ezpublish.php,v 1.14.2.10 2003/06/05 11:01:48 br Exp $
//
...
class eZPublish
{
    ...
    */
    function version()
    {
	// upstream provider branch version number
        // return "2.2.9";

	// Returns the xpublish branch version number


	// Return the rfp branch version number
