<?php
// 
// $Id: eznewscommand.php,v 1.6 2000/09/28 13:07:22 pkej-cvs Exp $
//
...
{
    /*!
        Constructs a new eZNewsCommand object.
     */
    function eZNewsCommand()
    {
        ...
        $TemplateDir = $this->ini->read_var( "eZTradeMain", "TemplateDir" );        
        
        $this->DocRoot = $ini->read_var( "eZNewsMain", "DocumentRoot" );
        $this->TemplateRoot = $DocRoot . $TemplateDir;        
        $this->LanguageRoot = $DocRoot . "/intl/" . $Language;
    ...
    function decodeTopLevel()
    {
        ...
        if( $this->Customer == "true" )
        {
            ...
            {
                new $CustomerClass( $this->URLArray );
            }
            else
            {
