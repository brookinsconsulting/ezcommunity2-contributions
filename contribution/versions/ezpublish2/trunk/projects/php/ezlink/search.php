<?
/*!
    $Id: search.php,v 1.17 2000/10/10 07:01:09 ce-cvs Exp $
...
$t = new eZTemplate( $DOC_ROOT . "/" . $ini->read_var( "eZLinkMain", "TemplateDir" ). "/search/",
$DOC_ROOT . "/intl", $Language, "search.php" );
$t->setAllStrings();
