...
$t->set_file( array(
    "link_page_tpl" => "onepagelinklist.tpl"
    ) );
$t->set_block( "link_page_tpl", "page_tpl", "page" );
$t->set_block( "page_tpl", "category_list_tpl", "category_list" );
...
$t->set_block( "page_tpl", "path_item_tpl", "path_item" );
