...
class eZUserGroup
{
  ...
  */  
	...
	CompanyDelete='$this->CompanyDelete'" );
  ...
  */  
    function update()
    {
		...
		AddressTypeAdmin='$this->AddressTypeAdmin',
	PersonDelete='$this->PersonDelete',
	CompanyDelete='$this->CompanyDelete' WHERE ID='$this->ID'" );
        }
    }
    ...
    function get( $id )
    {
        ...
        if ( $id != "" )
        {
            ...
            else if ( count( $user_group_array ) == 1 )
            {
                ...
                $this->PersonDelete = $user_group_array[ 0 ][ "PersonDelete" ];
                $this->CompanyDelete = $user_group_array[ 0 ][ "CompanyDelete" ];
            }
        }
    }
  ...
  */
    ...
    /*
    Rettighetene til å slette firma.
  */  
    function setCompanyDelete( $value )
    {
        $this->CompanyDelete = $value;
    }

    /*
    Rettighetene til å slette personer.
  */  
    function setPersonDelete( $value )
    {
        $this->PersonDelete = $value;
    }
