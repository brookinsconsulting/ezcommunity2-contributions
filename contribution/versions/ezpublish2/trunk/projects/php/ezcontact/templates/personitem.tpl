<tr>
	...
	<td bgcolor="{bg_color}"><a href="#" onClick="verify( 'Slette kontakt person?', 'index.php4?prePage={document_root}personedit.php4&Action=delete&PID={person_id}'); return false;">Slette person</a></td>
</tr>