<tr>
	...
	&nbsp;&nbsp;&nbsp;&nbsp;
	<a href="#" onClick="verify( 'Slette person type?', 'index.php?page={document_root}persontypeedit.php&Action=delete&PID={persontype_id}'); return false;" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('pti{persontype_id}-slett','','{document_root}images/slettminimrk.gif',1)"><img name="pti{persontype_id}-slett" border="0" src="{document_root}images/slettmini.gif" width="16" height="16" align="top"></a>
	&nbsp;&nbsp;
	</td>
</tr>
