<tr>
	...
	&nbsp;&nbsp;&nbsp;&nbsp;
	<a href="#" onClick="verify( 'Slette firma?', 'index.php4?prePage={document_root}companytypeedit.php4&Action=delete&CID={companytype_id}'); return false;" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('cti{companytype_id}-slett','','{document_root}images/slettminimrk.gif',1)"><img name="cti{companytype_id}-slett" border="0" src="{document_root}images/slettmini.gif" width="16" height="16" align="top"></a>
	&nbsp;&nbsp;
	</td>
</tr>
