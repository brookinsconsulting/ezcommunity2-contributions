...
<tr bgcolor="{color}">
    ...
    <td width="1%" class={td_class}>
        <a href="/forum/categoryedit/edit/{category_id}/" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('ef{category_id}-red','','/images/{site_style}/redigerminimrk.gif',1)"><img name="ef{category_id}-red" border="0" src="/images/{site_style}/redigermini.gif" width="16" height="16" align="top" border="0" alt="Edit" /></a>
    </td>
