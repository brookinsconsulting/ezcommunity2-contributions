...
<tr class="{theme-type_class}">
    ...
    <td width="1%"><a href="/cv/experience/edit/{experience_id}/" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('ezcvex{experience_id}-red','','/images/redigerminimrk.gif',1)"><img name="ezcvex{experience_id}-red" border="0" src="/images/redigermini.gif" width="16" height="16" align="top"></a></td>
    <td width="1%"><a href="/cv/experience/delete/{experience_id}/" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('ezcvex{experience_id}-slett','','/images/slettminimrk.gif',1)"><img name="ezcvex{experience_id}-slett" border="0" src="/images/slettmini.gif" width="16" height="16" align="top"></a></td>
</tr>
...
<tr class="{theme-type_class}">
    ...
    <td width="1%"><a href="/cv/education/edit/{education_id}/" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('ezcved{education_id}-red','','/images/redigerminimrk.gif',1)"><img name="ezcved{education_id}-red" border="0" src="/images/redigermini.gif" width="16" height="16" align="top"></a></td>
    <td width="1%"><a href="/cv/education/delete/{education_id}/" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('ezcved{education_id}-slett','','/images/slettminimrk.gif',1)"><img name="ezcved{education_id}-slett" border="0" src="/images/slettmini.gif" width="16" height="16" align="top"></a></td>
</tr>
...
<tr class="{theme-type_class}">
    ...
    <td width="1%"><a href="/cv/extracurricular/edit/{extracurricular_id}/" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('ezcvxt{extracurricular_id}-red','','/images/redigerminimrk.gif',1)"><img name="ezcvxt{extracurricular_id}-red" border="0" src="/images/redigermini.gif" width="16" height="16" align="top"></a></td>
    <td width="1%"><a href="/cv/extracurricular/delete/{extracurricular_id}/" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('ezcvxt{extracurricular_id}-slett','','/images/slettminimrk.gif',1)"><img name="ezcvxt{extracurricular_id}-slett" border="0" src="/images/slettmini.gif" width="16" height="16" align="top"></a></td>
</tr>
