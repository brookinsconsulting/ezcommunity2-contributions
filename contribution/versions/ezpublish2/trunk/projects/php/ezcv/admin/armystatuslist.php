...
$t = new eZTemplate( $DOC_ROOT . "/admin/" . $ini->read_var( "eZCVMain", "AdminTemplateDir" ), $DOC_ROOT . "admin/intl", $Language, "armystatus.php" );
$t->setAllStrings();

$item_type = new eZArmyStatus( $ArmyStatusID );
$page_path = "/cv/armystatus";
$item_error = true;
