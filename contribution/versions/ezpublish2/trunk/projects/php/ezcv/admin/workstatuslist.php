...
$t = new eZTemplate( $DOC_ROOT . "/admin/" . $ini->read_var( "eZCVMain", "AdminTemplateDir" ), $DOC_ROOT . "admin/intl", $Language, "workstatus.php" );
$t->setAllStrings();

$item_type = new eZWorkStatus( $WorkStatusID );
$page_path = "/cv/workstatus";
$item_error = true;
