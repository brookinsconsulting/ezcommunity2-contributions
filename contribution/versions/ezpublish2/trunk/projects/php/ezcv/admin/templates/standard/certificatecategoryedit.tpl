...
<form method="post" action="/cv/certificatecategory/{action_value}/{current_id}/" enctype="multipart/form-data">
<input type="hidden" name="max_file_size" value="3000000">
<p class="boxtext">{intl-th_category_name}:</p>
<input type="text" size="40" name="CategoryName" value="{current_name}">

<p class="boxtext">{intl-th_category_institution}:</p>
<input type="text" size="40" name="Institution" value="{current_institution}">
...
<tr>
	...
	<td>&nbsp;</td>
	<td>
	<form method="post" action="/cv/certificatecategory/list/{parent_id}/">
