...
$DOC_ROOT = $ini->read_var( "eZCVMain", "DocumentRoot" );
...
$t = new eZTemplate( $DOC_ROOT . "/admin/" . $ini->read_var( "eZCVMain", "AdminTemplateDir" ), $DOC_ROOT . "admin/intl", $Language, "maritalstatus.php" );
$t->setAllStrings();

$item_type = new eZMaritalStatus( $MaritalStatusID );
$page_path = "/cv/maritalstatus";
$item_error = true;
