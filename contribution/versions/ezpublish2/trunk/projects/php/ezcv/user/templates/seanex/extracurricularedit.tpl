...
<form method="post" action="/cv/extracurricular/{action_value}/{extracurricular_id}">

<input type="hidden" name="CVID" value="{cv_id}" />

<p class="boxtext">{intl-th_extracurricular_organization}:</p>
<input size="40" name="Organization" value="{extracurricular_organization}" />

<p class="boxtext">{intl-th_extracurricular_position}:</p>
<input size="40" name="Position" value="{extracurricular_position}" />

<p class="boxtext">{intl-th_extracurricular_speciality}:</p>
<input size="40" name="Speciality" value="{extracurricular_speciality}" />

<br /><br />
<table cellpadding="0" cellspacing="0" border="0">
<tr>
<td>
<p class="boxtext">{intl-th_extracurricular_start}:</p>
<table cellpadding="0" cellspacing="0" border="0">
<tr valign="bottom">
    <td>
...
<p class="boxtext">{intl-th_extracurricular_end}:</p>
<table cellpadding="0" cellspacing="0" border="0">
<tr>
    <td>
        <div class="small">{intl-year}:</div>
...
<p class="boxtext">{intl-th_extracurricular_comment}:</p>
<textarea rows="5" cols="40" name="Comment" wrap="soft">{extracurricular_comment}</textarea>
<br /><br />
