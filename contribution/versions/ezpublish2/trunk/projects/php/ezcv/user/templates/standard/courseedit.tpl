...
<input size="40" name="CourseName" value="{course_name}" />

<p class="boxtext">{intl-th_course_place}:</p>
<input size="40" name="CoursePlace" value="{course_place}" />
...
<tr>
    ...
    <td>
        <div class="small">{intl-month}:</div>
        <input type="text" size="2" name="StopMonth" value="{stopmonth}"/>&nbsp;&nbsp;
    </td>
    <td>
        <div class="small">{intl-day}:</div>
        <input type="text" size="2" name="StopDay" value="{stopday}"/>&nbsp;&nbsp;
    </td>
</tr>
</table>
</td>
