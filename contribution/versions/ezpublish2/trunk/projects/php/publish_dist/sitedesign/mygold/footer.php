...
<!--Footer Start -->
  ...
  <tr> 
	<td class="spacer" align="center" valign="bottom" bgcolor="#DDDDDD">&nbsp;</td>
	<td class="spacer" bgcolor="#DDDDDD">&nbsp;</td>
		...
		<tr> 
		  <td align="center" valign="middle" class="bg1000" width="99%"> 
			<p><br />
			  ...
			  &copy; 2000 My Gold AG <br />
			 
			  <a href="/trade/wishlist/">info@mygold.com</a> 
			  <br />
			  <br />
			 </p>
		  </td>
	...
	<td class="bgspacer20" align="right" valign="bottom">&nbsp;</td>
	<td class="spacer" align="center" valign="bottom" bgcolor="#DDDDDD">&nbsp;</td>
  </tr>
</table>
</body>
