...
\begin{itemize}
\item \texttt{\scriptsize RewriteEngine On}\texttt{\footnotesize }~\\
\texttt{\scriptsize RewriteRule \textasciicircum{}/filemanager/filedownload/({[}\textasciicircum{}/{]}+)/(.{*})\$
}~\\
\texttt{\scriptsize /path/to/website/ezfilemanager/files/\$1}~\\
\texttt{\scriptsize {[}T=\char`\"{}application/oct-stream\char`\"{},S=1{]}}~\\
\texttt{\scriptsize \#The lines above should appear on the same line
in your configuration file!}~\\
\texttt{\scriptsize RewriteRule !\textbackslash{}.(gif|css|jpg|png)\$
/path/to/website/index.php}{\scriptsize \par}
\end{itemize}
...
\begin{itemize}
\item \texttt{\scriptsize RewriteEngine On}~\\
\texttt{\scriptsize RewriteRule !\textbackslash{}.(gif|css|jpg|png)\$
/path/to/website/admin/index.php }{\scriptsize \par}
\end{itemize}
