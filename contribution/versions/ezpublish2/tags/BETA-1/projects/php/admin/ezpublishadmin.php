                  <table width="100%" border="0" cellspacing="0" cellpadding="4">
                    <tr bgcolor="#500A0A"> 
                      <td> 
                        <p class="smallhead">Artikler</p>
                      </td>
                    </tr>
                    <tr bgcolor="#C8B4B4"> 
                      <td>
                       <a class="small" href="index.php?page=../ezpublish/admin/main.php">Artikkeloversikt</a><br>
                       <a class="small" href="index.php?page=../ezpublish/admin/editarticlelist.php">Gjennomsyn</a><br>
