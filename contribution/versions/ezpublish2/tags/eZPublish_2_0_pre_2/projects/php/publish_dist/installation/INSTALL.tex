...
\begin{itemize}
\item Debian \texttt{\footnotesize (http://www.debian.org/distrib/ftplist)}
See also chapter \ref{chptr: debian}.
...
First read chapter \ref{chptr: debian}, then continue reading the
manual from here.
...
\section{Configuration of Virtual Host for win2000}
...
Decompress eZ publish to {}``c:\textbackslash{}ezpublish{}'', then
run {}``modfix.bat{}'' from the {}``ezpublish-win.files.zip{}''
distribution in that catalog.

Add the file {}``winINIFile.php{}'' from the {}``ezpublish-win.files.zip{}''
distribution to {}``c:\textbackslash{}ezpublish\textbackslash{}classes{}'':

\begin{itemize}
\item replace c:\textbackslash{}ezpublish\textbackslash{}classes\textbackslash{}INIFile.php
with the file from the {}``ezpublish-win.files.zip{}'' distribution.
\item replace c:\textbackslash{}ezpublish\textbackslash{}classes\textbackslash{}eztemplate.php
with the file from the {}``ezpublish-win.files.zip{}'' distribution.
\item replace c:\textbackslash{}ezpublish\textbackslash{}admin\textbackslash{}index.php
with the file from the \char`\"{}ezpublish-win.files.zip\char`\"{}
distribution.
\end{itemize}

\chapter{Debian\label{chptr: debian}}
