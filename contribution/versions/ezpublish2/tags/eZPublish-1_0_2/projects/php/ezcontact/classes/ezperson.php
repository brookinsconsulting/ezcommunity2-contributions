...
class eZPerson
{
    ...
    */
    function delete()
    {
        ...
        $result = mysql_query( "SELECT eZContact_Address.ID AS 'AID', eZContact_PersonAddressDict.ID AS 'DID' from eZContact_Address, eZContact_PersonAddressDict
 WHERE eZContact_Address.ID=eZContact_PersonAddressDict.AddressID AND eZContact_PersonAddressDict.PersonID='$this->ID' " )
        ...
        $result = mysql_query( "SELECT eZContact_Phone.ID AS 'PID', eZContact_PersonPhoneDict.ID AS 'DID' from eZContact_Phone, eZContact_PersonPhoneDict
