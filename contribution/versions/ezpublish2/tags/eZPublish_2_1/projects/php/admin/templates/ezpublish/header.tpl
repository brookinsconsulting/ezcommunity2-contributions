...
<!-- BEGIN module_item_tpl -->
	<td align="left"><a href="/module/{module_action}/{ez_module_name}?RefURL={ref_url}"><img src="/{ez_dir_name}/admin/images/module_icon.gif" width="32" height="32" border="0" alt="{module_name}" /></a></td>
<!-- END module_item_tpl -->
