...
<tr>
	...
	<a href="/contact/companytype/edit/{category_id}/" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('ezuser{category_id}-red','','/admin/images/redigerminimrk.gif',1)"><img name="ezuser{category_id}-red" border="0" src="/admin/images/redigermini.gif" width="16" height="16" align="top"></a>
	</td>

	<td class="{td_class}" width="1%">
	<a href="/contact/companytype/delete/{category_id}/" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('ezuser{category_id}-slett','','/admin/images/slettminimrk.gif',1)"><img name="ezuser{category_id}-slett" border="0" src="/admin/images/slettmini.gif" width="16" height="16" align="top"></a>
	</td>	
