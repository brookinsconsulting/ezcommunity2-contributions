...
<tr>
	...
	<td class="{td_class}">
	<a href="/trade/categorylist/parent/{product_category_id}/">{product_category}</a>
	</td>
...
<tr>
	...
	<td>
	<a class="path" href="/trade/search/{item_previous_index}/{search_text}">&lt;&lt;&nbsp;{intl-previous}</a>&nbsp;|
	</td>
	...
	<td>
	&nbsp;<a class="path" href="/trade/search/{item_index}/{search_text}">{type_item_name}</a>&nbsp;|
	</td>
	...
	<td>
	&nbsp;<a class="path" href="/trade/search/{item_next_index}/{search_text}">{intl-next}&nbsp;&gt;&gt;</a>
	</td>
