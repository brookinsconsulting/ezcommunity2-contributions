...
<tr>
	...
	<a href="{www_dir}{index}/article/articleedit/attributeedit/edit/{type_id}?ArticleID={article_id}/" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('eztp{article_id}-red','','/admin/images/{site_style}/redigerminimrk.gif',1)"><img name="eztp{article_id}-red" border="0" src="{www_dir}/admin/images/{site_style}/redigermini.gif" width="16" height="16" align="top" border="0" alt="Edit" /></a>
	</td>
