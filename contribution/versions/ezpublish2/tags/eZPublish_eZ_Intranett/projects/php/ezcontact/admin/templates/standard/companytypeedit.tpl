...
<a class="path" href="{www_dir}{index}/{intl-module_name}/{intl-category_command_type}/{intl-command_view}/{parent_id}">{parent_name}</a>
<!-- END path_item_tpl -->

<!-- BEGIN current_path_item_tpl -->
<img src="{www_dir}/admin/images/path-slash.gif" height="10" width="20" border="0">
<a class="path" href="{www_dir}{index}/{intl-module_name}/{intl-category_command_type}/{intl-command_view}/{parent_id}">{intl-current_edit}</a>
...
<form method="post" action="{www_dir}{index}/{intl-module_name}/{intl-category_command_type}/{action_value}/{current_id}/" enctype="multipart/form-data">
