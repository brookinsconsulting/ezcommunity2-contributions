<?
// 
// $Id: passwordchange.php,v 1.1 2000/10/02 15:46:55 ce-cvs Exp $
//
...
// Template
$t = new eZTemplate( $DOC_ROOT . $ini->read_var( "eZUserMain", "TemplateDir" ). "/passwordchange/",
                     $DOC_ROOT . "/intl", $Language, "passwordchange.php" );
$t->setAllStrings();
...
if ( $Action == "update" )
{
    if ( eZPermission::checkPermission( $user->login, "eZUser", "AdminLogin" ) )
    {
        print( "Du er medlem av admin gruppe, bytt passord på administrasjons grensesnittet." );
    }
