<?php
// 
// $Id: ezorder.php,v 1.61.8.7 2002/03/27 14:33:56 br Exp $
//
...
//              print( $user->id() );
    ...
    */
    function &getNew()
    {
        ...
        $db->array_query( $order_array,
        "SELECT ID FROM eZTrade_Order, eZTrade_PreOrder
         WHERE IsExported='0' AND eZTrade_PreOrder.ID = eZTrade_Order.ID" );
