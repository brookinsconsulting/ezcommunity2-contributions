<?php
// 
// $Id: menubox.php,v 1.28.4.2 2002/04/16 10:30:46 ce Exp $
//
...
$menuItems = array(
    ...
    array( "/trade/orderstats/", "{intl-orderstats}" ),
    ...
    array( "/trade/productspecialslist/", "{intl-specialslist}" ),
    array( "/trade/productspecialsedit/", "{intl-specialsedit}" ),        
    );
