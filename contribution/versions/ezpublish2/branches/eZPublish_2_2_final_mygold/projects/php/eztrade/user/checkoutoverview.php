...
if ( isSet ( $Next ) )
{
    $currentTypeID = $session->variable( "CurrentShippingTypeID" );
    ...
    $session->setVariable( "ShippingTypeID", $currentTypeID );
...
$t->set_block( "full_cart_tpl", "payment_item_tpl", "payment_item" );
