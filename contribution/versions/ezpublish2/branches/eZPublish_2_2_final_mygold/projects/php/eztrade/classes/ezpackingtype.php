<?php
//
// $Id: ezpackingtype.php,v 1.1.2.1 2002/06/10 08:48:21 ce Exp $
//
// Definition of eZPackingType class
//
// Created on: <23-Apr-2002 13:29:29 ce>
//
...
/*!
  Packing types is different kinds of packing methods.
...
class eZPackingtype
{
    ...
    */
    ...
    /*!
      Returns the packing VAT. That is the VAT value
      of the packing cost.

    */
    function &extractPackingVAT( )
    {
        $packVAT = 0;
        ...
        {
            $value =& $vatType->value();
            $packVAT = ( $packCost / ( $value + 100  ) ) * $value;
        }
        return $packVAT;
    }

    /*!
      Returns the packing VAT in percentage.

    */
    function &extractShippingVATPercentage( )
    {
        $VATPercentage = 0;
        $vatType =& $this->vatType();

        $packingCost = $this->price( );
    ...
    */
    ...
    /*!
      Returns the image of the packing as a eZImage object.
    ...
    */
    function image( )
    {
        if ( $this->ImageID != 0 )
        {
            return new eZImage( $this->ImageID, false );
        }
        else
        {
            return false;
