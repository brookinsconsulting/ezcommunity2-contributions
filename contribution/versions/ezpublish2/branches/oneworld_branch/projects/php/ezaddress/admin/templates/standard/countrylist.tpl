...
<!-- BEGIN item_linked_tpl -->
	<td>
        <a href="{www_dir}{index}{item_list_command}/{this_parent_id}/0/">{item_name}</a>
	</td>
<!-- END item_linked_tpl -->
...
<tr>
	...
	<td>
	<a class="path" href="{www_dir}{index}/address/{type}/{action}/{item_parent_id}/{item_previous_index}/{search_text}">&lt;&lt;&nbsp;{intl-previous}</a>
	</td>
	...
	<td>
	|&nbsp;<a class="path" href="{www_dir}{index}/address/{type}/{action}/{item_parent_id}/{item_index}/{search_text}">{type_item_name}</a>
	</td>
	...
	<td>
	|&nbsp;<a class="path" href="{www_dir}{index}/address/{type}/{action}/{item_parent_id}/{item_next_index}/{search_text}">{intl-next}&nbsp;&gt;&gt;</a>
	</td>
