...
<tr>
	...
	<a href="{www_dir}{index}/todo/statustypeedit/edit/{status_type_id}" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('ct{status_type_id}-red','','{www_dir}/admin/images/{site_style}/redigerminimrk.gif',1)"><img name="ct{status_type_id}-red" border="0" src="{www_dir}/admin/images/{site_style}/redigermini.gif" width="16" height="16" align="top" alt="Edit" /></a>
	</td>
	<td width="1%" class="{td_class}">
	<a href="{www_dir}{index}/todo/statustypeedit/delete/{status_type_id}" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('ct{status_type_id}-slett','','{www_dir}/admin/images/{site_style}/slettminimrk.gif',1)"><img name="ct{status_type_id}-slett" border="0" src="{www_dir}/admin/images/{site_style}/slettmini.gif" width="16" height="16" align="top" alt="Delete" /></a>
	</td>
</tr>
<!-- END status_item_tpl -->
